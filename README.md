...
- I predicted product demand with a bi-directional RNN model in this project.
...
- I used CNN with 2295 X-Ray images to classify Covid19 cases in this project.
...
- In this project, I used 17 years of monthly sales data to make sales predictions by using the LSTM model with Time Series Generator.
...
- In this project, I used the Transfer Learning method with MobileNetV2.
...
- I made frozen desert production predictions for the next 24 months.
...
- In this project, I used Auto-Encoders to perform denoising.
...
- Also I applied sparse categorical cross-entropy for pixel-wise prediction.
...
- I mapped face images into 128-dimensional encodings using a pre-trained model and performed face verification and face recognition with these encodings.
